...
namespace Microsoft.Boogie
{
  ...
  public class ExecutionEngine
  {
...
#endif
      if (CommandLineOptions.Clo.LearnerExecutable != null)
      {
    ...
    private static PipelineOutcome RunMLHoudini(Program program, PipelineStatistics stats, ErrorReporterDelegate er, string filename)
    {
        ...
        // Run Abstract Houdini
        var mlice = new Houdini.MLHoudini(program, CommandLineOptions.Clo.LearnerExecutable, filename, CommandLineOptions.Clo.LearnerOptions, CommandLineOptions.Clo.MLHoudiniUseBounds);
