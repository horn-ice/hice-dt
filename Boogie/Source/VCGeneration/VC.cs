...
namespace VC {
  ...
  public class VCGen : ConditionGeneration {
    ...
    public class P_ErrorReporter : ProverInterface.ErrorHandler
    {
      Dictionary<TransferCmd, ReturnCmd>/*!*/ gotoCmdOrigins;
      Dictionary<int, Absy>/*!*/ label2absy;
      List<Block/*!*/>/*!*/ blocks;
      ...
      public static TextWriter ModelWriter
      {
        get
        {
          ...
          if (P_ErrorReporter.modelWriter == null)
            P_ErrorReporter.modelWriter = CommandLineOptions.Clo.PrintErrorModelFile == null ? Console.Out : new StreamWriter(CommandLineOptions.Clo.PrintErrorModelFile, false);
          return P_ErrorReporter.modelWriter;
        }
      }
      ...
      public P_ErrorReporter(Dictionary<TransferCmd, ReturnCmd>/*!*/ gotoCmdOrigins,
          Dictionary<int, Absy>/*!*/ label2absy,
          List<Block/*!*/>/*!*/ blocks,
          ...
          HashSet<string> constantsAssumed)
      {
        ...
        this.constantsAssumed = constantsAssumed;
      }
      ...
      public override void OnModel(IList<string/*!*/>/*!*/ labels, Model model)
      {
        ...
        if (CommandLineOptions.Clo.PrintErrorModel >= 1 && model != null)
        {
          ...
          model.Write(P_ErrorReporter.ModelWriter);
          P_ErrorReporter.ModelWriter.Flush();
        }
      ...
      foreach (DictionaryEntry tracenode in traceNodes)
      {
        ...
        */
        ...
        Counterexample newCounterexample = P_TraceCounterexample(entryBlock, traceNodes, trace, assumedCmds, model, MvInfo, incarnationOriginMap, context, new Dictionary<TraceLocation, CalleeCounterexampleInfo>(), constantsAssumed);
...
//      #endregion
    ...
    static Counterexample P_TraceCounterexample(
                           Block/*!*/ b, Hashtable/*!*/ traceNodes, List<Block>/*!*/ trace, List<Cmd> /*!*/ assumedCmds,
                           Model errModel, ModelViewInfo mvInfo,
                           Dictionary<Incarnation, Absy/*!*/>/*!*/ incarnationOriginMap,
                           ProverContext/*!*/ context,
...
           else
            {
             // If labels are not used, then add all assumeCmds in the current block that
              // contain any existential function to assumeCmds
             var funcsUsed = FunctionCollector.Collect(((AssumeCmd)cmd).Expr);
...
           if (traceNodes.Contains(bb))
           {
             trace.Add(bb);
             return P_TraceCounterexample(bb, traceNodes, trace, assumedCmds, errModel, mvInfo, incarnationOriginMap, context, calleeCounterexamples, constantsAssumed);
           }
         }
       }
       return null;
